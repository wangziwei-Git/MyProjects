...
public class MessageConstant {
    public static final String DELETE_CHECKITEM_OR_CHECKGROUP__FAIL = "当前检查组和检查项之间存在关联关系，不能删除";
    public static final String DELETE_SETMEAL_OR_CHECKGROUP__FAIL = "当前套餐和检查组之间存在关联关系，不能删除";
    ...
    public static final String EDIT_SETMEAL_SUCCESS = "查询套餐数据成功";
    public static final String EDIT_SETMEAL_FAIL = "查询套餐数据失败";
